...
export async function getGraphStatus(args: GetGraphStatusArgs): Promise<GetGraphStatusResponse> {
  return await fetch(`http://localhost:6666/api/get_graph_status?graph=${args.graph}`, {
    method: 'POST',
...
export async function listAvailableGraphs(
  ...
  return await fetch('http://localhost:6666/api/list_avail_graphs', {
    method: 'POST',
    signal: args.controller?.signal,
  }).then((res) =>
    res.json().then((json) => {
...
export async function listLabels(args: ListLabelsArgs): Promise<ListLabelsResponse> {
  return await fetch(`http://localhost:6666/api/list_labels?graph=${args.graph}`, {
    method: 'POST',
    signal: args.controller?.signal,
    body: JSON.stringify({
...
export async function listPropertyTypes(
  ...
  return await fetch(`http://localhost:6666/api/list_property_types?graph=${args.graph}`, {
    method: 'POST',
    signal: args.controller?.signal,
    body: JSON.stringify({
...
export async function listEdgeTypes(args: ListEdgeTypesArgs): Promise<ListEdgeTypesResponse> {
  return await fetch(`http://localhost:6666/api/list_edge_types?graph=${args.graph}`, {
    method: 'POST',
    signal: args.controller?.signal,
    body: JSON.stringify({
...
export async function listNodes(args: ListNodesArgs): Promise<ListNodesResponse> {
  return await fetch(`http://localhost:6666/api/list_nodes?graph=${args.graph}`, {
    method: 'POST',
    signal: args.signal,
    body: JSON.stringify({
      labels: args.labels || [],
...
export async function getNeighbors(args: GetNeighborsArgs): Promise<GetNeighborsResponse> {
  return await fetch(`http://localhost:6666/api/get_neighbors?graph=${args.graph}`, {
    method: 'POST',
    signal: args.controller?.signal,
    body: JSON.stringify({
      nodeIDs: args.nodeIDs,
...
export async function getNodes(args: GetNodesArgs): Promise<GetNodesResponse> {
  return await fetch(`http://localhost:6666/api/get_nodes?graph=${args.graph}`, {
    method: 'POST',
    signal: args.controller?.signal,
    body: JSON.stringify({
      nodeIDs: args.nodeIDs,
...
export async function getNodeProperties(
  ...
  return await fetch(`http://localhost:6666/api/get_node_properties?graph=${args.graph}`, {
    method: 'POST',
    signal: args.controller?.signal,
    body: JSON.stringify({
      nodeIDs: args.nodeIDs,
...
export async function getNodeEdges(args: GetNodeEdgesArgs): Promise<GetNodeEdgesResponse> {
  return await fetch(`http://localhost:6666/api/get_node_edges?graph=${args.graph}`, {
    method: 'POST',
    signal: args.controller?.signal,
    body: JSON.stringify({
      nodeIDs: args.nodeIDs,
...
export async function exploreNodeEdges(
  ...
  return await fetch(`http://localhost:6666/api/explore_node_edges?graph=${args.graph}`, {
    method: 'POST',
    signal: args.controller?.signal,
    body: JSON.stringify({
      nodeID: args.nodeID,
...
export async function getEdges(args: GetEdgesArgs): Promise<GetEdgesResponse> {
  return await fetch(`http://localhost:6666/api/get_edges?graph=${args.graph}`, {
    method: 'POST',
    signal: args.controller?.signal,
    body: JSON.stringify({
      edgeIDs: args.edgeIDs,
