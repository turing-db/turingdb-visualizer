...
document.addEventListener('DOMContentLoaded', () => {
  const passwordFieldsWrappers = document.querySelectorAll('.auth0-lock-input-password')

  passwordFieldsWrappers.forEach((passwordFieldWrapper) => {
    ...
    toggleButton.addEventListener('click', () => {
      const passwordInput = passwordFieldWrapper.querySelector('.auth0-lock-input')
      const inputType = passwordInput.getAttribute('type')
      if (inputType === 'password') {
        passwordInput.setAttribute('type', 'text')
        toggleButton.innerHTML = eyeIconOff
      } else {
